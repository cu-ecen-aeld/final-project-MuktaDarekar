...
SRC_URI = "git://git@github.com/cu-ecen-aeld/final-project-support-vishnu-mukta;protocol=ssh;branch=master"

PV = "1.0+git${SRCPV}"
# TODO: set to reference a specific commit hash in your assignment repo
#SRCREV = "d7930fad8f2c3fdf1932e95c33a3206e690b45d8"
SRCREV = "bf20412366841ccea4ea8b59f667c7ccc8585d0e"

# This sets your staging directory based on WORKDIR, where WORKDIR is defined at 
# https://www.yoctoproject.org/docs/latest/ref-manual/ref-manual.html#var-WORKDIR
# We reference the "server" directory here to build from the "server" directory
# in your assignments repo
S = "${WORKDIR}/git/capture_image"
...
do_install () {
	...
	install -m 0755 ${S}/search.sh ${D}${bindir}/	
}
